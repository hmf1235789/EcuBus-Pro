    ...
    <div :id="tableId">
        <VxeGrid ref="xGrid" v-bind="gridOptions" @cell-click="cellClick">
            <template #toolbar>
                <div class="schedule-toolbar">
                    ...
                    <div class="add-frame-form">
                        <el-form ref="formRef" :model="addFrameForm" :rules="formRules" :inline="true" size="small">
                            <el-form-item label="Frame Type" prop="type">
                                <el-select v-model="addFrameForm.type" style="width: 160px"
                            ...
                            <template v-if="addFrameForm.type === 'existing'">
                                <el-form-item label="Frame" prop="frameName">
                                    <el-select v-model="addFrameForm.frameName" style="width: 200px">
                                        <el-option v-for="frame in availableFrames" :key="frame" :label="frame"
                                            :value="frame" />
                                    </el-select>
                                </el-form-item>
                            </template>
                            ...
                            <template v-if="addFrameForm.type === 'EventTrigger'">
                                ...
                                <el-form-item label="Frames" prop="frameNames">
                                    <el-select v-model="addFrameForm.frameNames" multiple collapse-tags
                                        style="width: 200px">
                                        <el-option v-for="frame in availableFrames" :key="frame" :label="frame"
                                            :value="frame" />
                                    </el-select>
                            ...
                            <template v-if="addFrameForm.type === 'Sporadic'">
                                ...
                                <el-form-item label="Frames" prop="frameNames">
                                    <el-select v-model="addFrameForm.frameNames" multiple collapse-tags style="width: 200px">
                                        <el-option v-for="frame in masterFrames" :key="frame" :label="frame" :value="frame" />
                                    </el-select>
                                </el-form-item>
                            </template>
                            ...
                            <template
                                v-if="['AssignNAD', 'SaveConfiguration', 'AssignFrameId'].includes(addFrameForm.type)">
                                <el-form-item label="Node" prop="nodeName">
                                    <el-select v-model="addFrameForm.nodeName" style="width: 150px" >
                                        <el-option v-for="node in props.ldf.node.salveNode" :key="node" :label="node"
                                            :value="node" />
                                    </el-select>
                                </el-form-item>
                            </template>
                            ...
                            <template v-if="addFrameForm.type === 'AssignFrameId'">
                                <el-form-item label="Frame" prop="frameName">
                                    <el-select v-model="addFrameForm.frameName" style="width: 200px">
                                        <el-option v-for="frame in availableConfigFrames" 
                                                  :key="frame" 
                                                  :label="frame" 
                                                  :value="frame" />
                                    </el-select>
                            ...
                            <template v-if="addFrameForm.type === 'ConditionalChangeNAD'">
                                <el-form-item label="NAD" prop="nad">
                                    <el-input-number v-model="addFrameForm.nad" :min="0" :max="255" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                                <el-form-item label="ID" prop="id">
                                    <el-input-number v-model="addFrameForm.id" :min="0" :max="65535" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                                <el-form-item label="Byte" prop="byte">
                                    <el-input-number v-model="addFrameForm.byte" :min="0" :max="255" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                                <el-form-item label="Mask" prop="mask">
                                    <el-input-number v-model="addFrameForm.mask" :min="0" :max="255" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                                <el-form-item label="Inv" prop="inv">
                                    <el-input-number v-model="addFrameForm.inv" :min="0" :max="255" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                                <el-form-item label="New NAD" prop="newNad">
                                    <el-input-number v-model="addFrameForm.newNad" :min="0" :max="255" style="width: 100px" controls-position="right"/>
                                </el-form-item>
                            </template>
                            ...
                            <template v-if="addFrameForm.type === 'DataDump'">
                                ...
                                <el-form-item label="D1" prop="D1">
                                    <el-input-number v-model="addFrameForm.D1" 
                                                    :min="0" 
                                                    :max="255" 
                                                    style="width: 100px" 
                                ...
                                <el-form-item label="D2" prop="D2">
                                    <el-input-number v-model="addFrameForm.D2" 
                                                    :min="0" 
                                                    :max="255" 
                                                    style="width: 100px" 
                                                    controls-position="right"/>
                                ...
                                <el-form-item label="D3" prop="D3">
                                    <el-input-number v-model="addFrameForm.D3" 
                                                    :min="0" 
                                                    :max="255" 
                                                    style="width: 100px" 
                                                    controls-position="right"/>
                                ...
                                <el-form-item label="D4" prop="D4">
                                    <el-input-number v-model="addFrameForm.D4" 
                                                    :min="0" 
                                                    :max="255" 
                                                    style="width: 100px" 
                                                    controls-position="right"/>
                                ...
                                <el-form-item label="D5" prop="D5">
                                    <el-input-number v-model="addFrameForm.D5" 
                                                    :min="0" 
                                                    :max="255" 
                                                    style="width: 100px" 
                                                    controls-position="right"/>
                            ...
                            <template v-if="addFrameForm.type === 'AssignFrameIdRange'">
                                ...
                                <el-form-item label="Frame Index" prop="frameIndex">
                                    <el-input-number v-model="addFrameForm.frameIndex" 
                                                    :min="0" 
                                                    :max="3" 
                                                    style="width: 100px" 
                                                    controls-position="right"/>
                                ...
                                <el-form-item label="Frame PIDs" prop="framePIDs">
                                    <div style="display: flex; gap: 8px;">
                                        <el-input-number v-for="(_, index) in 4" 
                                                        :key="index"
            ...
            <template #default_operate>
                <el-button-group>
                    <el-button link type="danger" @click="deleteFrame" title="Delete Frame">
                        <Icon :icon="deleteIcon" />
                    </el-button>
                </el-button-group>
            </template>
...
const formRules = computed<FormRules>(() => ({
    ...
    name: [{
        required: addFrameForm.value.type === 'EventTrigger'||addFrameForm.value.type === 'Sporadic',
    ...
    },
    {
        validator: (rule: any, value: any, callback: any) => {
            ...
            const conflictEvent = Object.entries(props.ldf.eventTriggeredFrames)
              .find(([k,v]) => k === value && v.schTableName !== props.editIndex)
            if (conflictEvent) {
    ...
    nodeName: [{
        required: ['AssignNAD', 'SaveConfiguration', 'AssignFrameId','DataDump','AssignFrameIdRange'].includes(addFrameForm.value.type),
    ...
    frameName: [{
        required: addFrameForm.value.type === 'AssignFrameId'||addFrameForm.value.type === 'existing',
        ...
        validator: (rule: any, value: any, callback: any) => {
          ...
          if (addFrameForm.value.nodeName) {
            ...
            if (value >= configFrames.length) {
              callback(new Error(`Frame index exceeds available configurable frames (${configFrames.length})`))
              return
            }
          }
          callback()
