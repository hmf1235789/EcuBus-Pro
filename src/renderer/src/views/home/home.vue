<template>
    <el-container class="homeCtr" v-loading="loading">
        ...
        <el-tabs tab-position="left" v-model="activeMenu" class="main" @tab-change="mainTabChange" lazy>
            <el-tab-pane name="return" v-if="project.open">
                <template #label>
                    <div class="menu-item normal">
                        <svg style="transform: rotate(180deg);font-size:26px;padding:6px"
                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 2048 2048">
            ...
            <el-tab-pane name="close" v-if="project.open">
                <template #label>
            ...
            <el-tab-pane name="home">
                ...
                <div class="lr">
                    ...
                    <div>
                        ...
                        <el-tabs class="homeMenu" v-model="homeActiveMenu">
                            <el-tab-pane name="recent">
                                <template #label>
                                    <div class="mx-1">
                                        <Icon :icon="recentIcon"></Icon> <span>Recent</span>
                                    </div>
                                ...
                                <div class="recent">
                                    ...
                                    <el-scrollbar :height="recentHeight">
                                        <div v-for="p in projectList.projectList" :key="p.path" class="pitem"
                                            @click="openProject(p)">
                                            ...
                                            <div style="display: flex;gap:20px;align-items: center;;width:100px">
                                                <Icon class="closeIcon" :icon="close"
                                                    @click.stop="projectList.deleteProject(p)"
                                                    style="color:var(--el-color-info-light-3);font-size: 20px;display: none;" />
                                                <Icon class="openIcon" :icon="pinIcon"
                                                    @click.stop="projectList.pinProject(p)"
                                                    :style="{ display: p.pined ? 'block' : 'none', color: p.pined ? 'var(--el-color-primary)' : 'var(--el-color-info-light-3)' }"
                            ...
                            <el-tab-pane name="pin">
                                <template #label>
                                    <div class="mx-1">
                                        <Icon :icon="pinIcon"></Icon> <span>Pinned</span>
                                    </div>
                                ...
                                <div class="recent">
                                    ...
                                    <el-scrollbar :height="recentHeight">
                                        <div v-for="p in pinedProjectList" :key="p.path" class="pitem"
                                            @click="openProject(p)">

                                            <div>
                                                <div class="name">{{ p.name }}</div>
                                                <div
                                                    style="color: var(--el-color-info-dark-2);font-size: 15px;font-weight:500;max-width: 400px;overflow: hidden;  text-overflow: ellipsis;">
                                                    {{
                                                        p.path }}</div>
                                            </div>
                                            <div class="timestamp">{{ formatDate(p.lastOpenTime) }}</div>
            ...
            <el-tab-pane name="user">
                ...
                <el-tabs v-model="activeSet" class="settingMenu">
                    ...
                    <el-tab-pane label="Update" name="second">
                        ...
                        <update :height="height" v-model="hasUpdate" />
                    </el-tab-pane>
                </el-tabs>
...
onMounted(() => {
    window.electron.ipcRenderer.invoke('ipc-get-version', ecubusPro).then((v) => {
        log.debug(v)
